...
template <> constexpr inline auto LoginDialog::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginDialogE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onCaptchaReady'
        QtMocHelpers::SlotData<void(const QString &, const QPixmap &)>(3, 2, QMC::AccessPrivate, QMetaType::Void, {{
...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onCaptchaReady((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QPixmap>>(_a[2]))); break;
        default: ;
        }
    }
}
