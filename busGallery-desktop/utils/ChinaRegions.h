#ifndef CHINAREGIONS_H
#define CHINAREGIONS_H
...
// All 34 province-level divisions with major cities
inline const QList<ProvinceData> CHINA_REGIONS = {
    {"北京市", {"北京市"}},
    {"天津市", {"天津市"}},
    {"上海市", {"上海市"}},
    {"重庆市", {"重庆市"}},
    ...
    {"新疆", {"乌鲁木齐市","克拉玛依市","吐鲁番市","哈密市","昌吉州","博尔塔拉州","巴音郭楞州","阿克苏地区","克孜勒苏州","喀什地区","和田地区","伊犁州","塔城地区","阿勒泰地区","石河子市"}},
